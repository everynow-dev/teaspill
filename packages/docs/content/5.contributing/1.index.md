...
teaspill's full design history — every architectural decision and why — lives in the repository under [`work/`](https://github.com/everynow-dev/teaspill/tree/main/work) (start with `work/README.md`).
