...
Patterns cover agents talking to each other — including steering a busy peer mid-run. For intervening from the *outside* — interrupting, pausing, archiving — continue to [Lifecycle & control](/concepts/lifecycle), which also covers where steer fits.
